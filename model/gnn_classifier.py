...
CUSTOM_ANCHORS = [
    ...
    ("pm of india is modi", 1),
    ("india pm is modi", 1),
    ("modi is pm of india", 1),
    ("modi is the prime minister", 1),
    ("prime minister of india is modi", 1),
    ("modi is prime minister of india", 1),
    ("narendra modi is pm of india", 1),
    ("modi is india pm", 1),
    ("Droupadi Murmu is the President of India.", 1),
    ("president of india is droupadi murmu", 1),
